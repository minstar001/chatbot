var mergebounce = (function () {
   ...
   *  This option is similar to `concatArrays`, expect that the concatenated
   *  array will also be deduplicated. Thus any entries that are concatenated to the
   *  existing array, which are already contained in the existing array, will be
   *  removed.
